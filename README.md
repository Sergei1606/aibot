...
| 🖥 **Веб-интерфейс и Админка** | Визуализация статистики, последних постов и полноценная панель управления (`/admin`) для удобного добавления/удаления источников и ключевых слов без изменения кода. |
...
- **Веб-интерфейс (Дашборд):** [http://localhost:8000/](http://localhost:8000/)
- **Веб-интерфейс (Админ-панель):** [http://localhost:8000/admin](http://localhost:8000/admin)
